#!/usr/bin/env python3
"""
Download the missing pronunciation clips for tingxie row 97 from Google
...
Usage:
    python3 scripts/download_row97_audio.py
"""
...
WORDS = [
    "沿着", "拍照片", "讨论", "检查", "仍然", "急忙", "地图", "眼睛圆圆",
    "咬断", "吃饱", "慢慢", "软软", "笨重", "有趣", "打滚", "小偷",
]
