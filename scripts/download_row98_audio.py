#!/usr/bin/env python3
"""
Download the missing pronunciation clips for tingxie row 98 from Google
...
Usage:
    python3 scripts/download_row98_audio.py
"""
...
WORDS = [
    "课室", "漫画", "吓得逃走", "冒出冷汗", "掉", "练习", "肚皮", "数学简单",
    "泡泡", "立刻", "结果", "闹笑话", "不敢挖", "痛", "跳舞",
]
