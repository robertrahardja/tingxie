...
export const Route = createFileRoute('/p3hcl-reading-9')({
  component: P3HCLReading9Page,
})
    ...
    const loadData = async () => {
      try {
        const [textResponse, wordsResponse] = await Promise.all([
          fetch('/data/p3hcl_reading_9.json'),
          fetch('/data/p3hcl_reading_9_words.json')
        ])
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              {currentText.audioTimestamps.map((ts, idx) => {
                ...
                const isTitle = ts.text === currentText.title
